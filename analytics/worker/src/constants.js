...
export const AGENT_TASK_STAGE_PATTERN = /^[a-z][a-z0-9-]{0,49}$/;
export const AGENT_RUNTIME_MAX_DURATION_MS = 24 * 60 * 60 * 1000;
...
export const GITHUB_REPO_FULL_NAME = 'Cyberceratops/OpenBidKit_Yibiao';
...
export const MODEL_INFO_SYNC_CRON = '0 19 * * *';
